...
### Programar, es hablarle a la máquina a travez de un lenguaje que pueda entender.

Como la computadora solo entiende lenguaje binario ( 0 y 1 ), creamos lenguajes que nos permiten comunicarnos con ella utilizando lenguaje humano (mayormente ingles). Nosotros hablamos español, las maquinas hablan JavaScript, Python, Ryby, etc. Estos son llamados lenguajes de programación.
